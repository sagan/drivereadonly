...
//            return;
    ...
    findAndHookMethod("com.google.android.gms.auth.GoogleAuthUtil", lpparam.classLoader, "getToken", Context.class, String.class, String.class, new XC_MethodHook() {
      @Override
      protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
        String oauthScopes = (String) param.args[2];
        if (oauthScopes.equals("oauth2: https://www.googleapis.com/auth/drive")) {
          param.args[2] = "oauth2: https://www.googleapis.com/auth/drive.readonly";
        }
      }
    });
  }
